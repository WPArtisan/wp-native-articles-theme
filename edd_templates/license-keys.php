...
<div class="overflow-auto">
	<table id="edd_sl_license_keys" class="f6 w-100 mw8 b--light-gray ba bw2 br2" cellspacing="0">
		<thead>
			<tr class="edd_sl_license_row">
				<?php do_action('edd_sl_license_keys_header_before'); ?>
				<th class="fw6 bb b--light-gray tl pa3 bg-light-gray"><?php _e( 'Item', 'edd_sl' ); ?></th>
				<th class="fw6 bb b--light-gray tl pa3 bg-light-gray"><?php _e( 'License Details', 'edd_sl' ); ?></th>
									...
									<li class="edd-sl-child">
										<span>
											...
											if ( ! edd_software_licensing()->force_increase() ) {
												...
												?>
												&nbsp;&ndash;&nbsp;<a class="link" href="<?php echo $url; ?>"><?php _e( 'Manage Sites', 'edd_sl' ); ?></a>
												<?php
											}
											?>
										</span>
