...
<main class="pa4 black-80">
	<form id="edd_profile_editor_form" class="edd_form measure center" action="<?php echo edd_get_current_page_url(); ?>" method="post">
		<fieldset id="sign_up" class="ba b--transparent ph0 mh0">
			...
			<div class="mv3">
				<label class="db fw6 lh-copy f6" for="edd_display_name"><?php _e( 'Display Name', 'easy-digital-downloads' ); ?></label>
				<select name="edd_display_name" id="edd_display_name" class="pa2 input-reset ba bg-transparent w-100 select edd-select">
			...
			<div class="mv3">
				<label class="db fw6 lh-copy f6" for="edd_email"><?php _e( 'Primary Email Address', 'easy-digital-downloads' ); ?></label>
			...
			<div class="mv3">
				<label class="db fw6 lh-copy f6" for="edd_emails"><?php _e( 'Additional Email Addresses', 'easy-digital-downloads' ); ?></label>
			...
			<legend class="f4 fw6 ph0 mh0">Change your Billing Address</legend>
			...
			<legend class="f4 fw6 ph0 mh0">Change your Password</legend>
		...
		<div class="">
			...
			<input name="edd_profile_editor_submit" id="edd_profile_editor_submit" type="submit" class="b ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib edd_submit" value="<?php _e( 'Save Changes', 'easy-digital-downloads' ); ?>"/>
		</div>
